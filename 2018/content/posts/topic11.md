...
date = "2018-03-19"
description = "Reference-based RNA seq"
...
|              |
|--------------|
|[![](/img/stranded_protocols.png)](http://www.nature.com/nmeth/journal/v7/n9/fig_tab/nmeth.1491_F1.html)|
...
|              |
|--------------|
|[![](/img/lib_type.png)](http://sailfish.readthedocs.org/en/master/library_type.html)|
...
|              |
|--------------|
|[![](/img/tophat.png)](http://bioinformatics.oxfordjournals.org/content/25/9/1105/F1.expansion.html)|
...
|              |
|--------------|
|[![](/img/tophat2.png)](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2013-14-4-r36)|
...
|              |
|--------------|
|[![](/img/rnaseq_comparison.png)](http://bioinformatics.oxfordjournals.org/content/early/2015/09/08/bioinformatics.btv488/F5.large.jpg)
...
![](/img/rnaseq_library.png)

The datasets will appear in your history:

![](/img/rnaseq_data_in_history.png)
...
[![](/img/htseq_count.png)](http://www-huber.embl.de/users/anders/HTSeq/doc/count.html)
...
[![](/img/ucsc_dm3.png)](/img/ucsc_dm3.png)

+++
categories = []
date = "2017-02-20T17:19:07-05:00"
#draft = true
featureimage = "img/topic10_cover.png"
menu = ""
tags = []
title = "11. Finding really low frequency variants"
description = "**Topic 11** | Finding *really* low frequency variants"
+++
...
>[![duplex](/BMMB554/img/ds.png)](http://www.pnas.org/content/109/36/14508/F1.expansion.html)
>
...
We uploaded [Schmitt:2015](http://www.nature.com/nmeth/journal/v12/n5/full/nmeth.3351.html)) data directly from SRA as shown in [this screencast](https://vimeo.com/121187220). This created two datasets in our galaxy history: one for forward reads and one for reverse. We then evaluated the quality of the data by running FastQC on both datasets (forward and reverse) to obtain the following plots:
   ...
   | 
:--|:---
![](/BMMB554/img/abl1-f-qc.png) | ![](/BMMB554/img/abl1-r-qc.png)
**A**. Forward  | **B**. Reverse
...
>![Make consesni](/BMMB554/img/makeCons.png)
>
...
>![ContentTrimmer](/BMMB554/img/contentTrimmer.png)
>
...
>![ContentTrimmer](/BMMB554/img/combineFandQ.png)
>
>Combine FASTA and QUAL. **Note** that here two datasets (#8 and #9) are selected simultaneously because we clicked the multiple datasets button the left of the **FASTA File** dropdown:<br> ![](/BMMB554/img/multiDataset.png)
...
>[![](/BMMB554/img/fromReads.png)](https://galaxyproject.org/duplex/fromReads.png)
>
>Starting from Reads 


>[![](/BMMB554/img/fromDCS.png)](https://galaxyproject.org/duplex/fromDCS.png)
>
